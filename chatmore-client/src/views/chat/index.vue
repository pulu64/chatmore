  ...
  <div class="chat-page">
    ...
    <div class="chat-window">
      ...
      <div class="prompt" v-show="isHide">
        <el-avatar :size="80" :src="`http://127.0.0.1:3000/avatar/${personalDetail.profilePicture}`"/>
              ...
              <div class="avatar">
                <RouterLink :to="{ name: 'profile', query: { id,type } }" active-class="active">
                  <el-badge is-dot class="item" :offset="[-6, 6]"  badge-style="width:11px;height:11px;">
                    <el-avatar :size="50" :src="`http://127.0.0.1:3000/avatar/${avatar}`"/>
                  </el-badge>
                </RouterLink>
              </div>
        ...
        <el-footer>
          ...
          <el-button color=var(--bs-green) @click="handleSendMessage">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class=" iconify iconify--ri" width="1em" height="1em" viewBox="0 0 24 24">
              <path fill="currentColor" d="M1.946 9.315c-.522-.174-.526-.455.01-.634L21.044 2.32c.529-.176.832.12.684.638l-5.454 19.086c-.15.529-.455.547-.678.045L12 14l6-8l-8 6z"></path>
          </svg>
          </el-button>
        </el-footer>
