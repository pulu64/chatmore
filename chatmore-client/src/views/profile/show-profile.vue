    ...
    <div class="show-window">
      ...
      v-if="type==='user'"
        ...
        <el-descriptions-item label="个性签名">
          <el-tag size="small">School</el-tag>{{ info }}
      ...
      v-if="type==='group'"
        ...
        <el-descriptions-item label="群介绍" v-if="info" :span="2">
          <el-tag size="small">School</el-tag>{{ info }}
        </el-descriptions-item>
            ...
            <div class="media"  v-for="item in members" :key="item._id">
              <div class="avatar">
                <el-badge is-dot :offset="[-6, 6]" color="var(--bs-green)" badge-style="width:11px;height:11px;">
                  <el-avatar :size="50" :src="`http://127.0.0.1:3000/avatar/${item.profilePicture}`" alt="Avataaars" />
                </el-badge>
              </div>
                  ...
                  <template #dropdown >
                    <el-dropdown-menu>
                      <el-dropdown-item command="viewProfile">
                        <RouterLink :to="{ name: 'profile', query: { id:item.userId,type:'user' } }">
                          查看资料
                        </RouterLink>
                      </el-dropdown-item>
